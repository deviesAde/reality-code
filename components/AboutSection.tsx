    ...
    return (
        <div className="relative w-full">
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 md:gap-24 items-start">
                ...
                <div className="flex flex-col space-y-16 pt-0 md:pt-48">
                    <motion.div
                    ...
                    >
                        <p className="text-white/80 text-lg md:text-2xl leading-snug font-medium max-w-[65ch] prose">
                        ...
                        <p className="text-white/60 text-base md:text-lg leading-[1.6] max-w-[65ch] prose">
                        ...
                        <div className="p-8 sm:p-10 bg-white/[0.03] border-l-4 border-[#E10600] backdrop-blur-sm">
                            <p className="text-xs font-bold uppercase tracking-[0.5em] text-[#E10600] mb-5 font-mono">Professionalism</p>
            ...
            <motion.div
                ...
                className="mt-48 md:mt-64 pb-32 md:pb-64 w-full"
            >
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/10 border border-white/10">
                    {[
                        ...
                        <div key={item.val} className="bg-[#0A0A0A] p-6 sm:p-10 flex flex-col items-center text-center group hover:bg-[#E10600] transition-colors duration-500">
                            ...
                            <div className="text-[11px] text-white/40 uppercase tracking-[0.2em] font-bold group-hover:text-white/70 transition-colors font-mono">{item.desc}</div>
                        </div>
                    ))}
                </div>
            </motion.div>
